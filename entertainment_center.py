...
'''In this section of python coding. 
I am using Avatar Movie Trailer that is using sytext of media.py to genrate that infornation on this movie.'''
...
'''In this section of python coding. 
   I am using Bad Moms Movie Trailer that is using sytext of media.py to genrate that infornation on this movie.'''
...
'''In this section of python coding. 
   I am using Bang Bang Movie Trailer that is using sytext of media.py to genrate that infornation on this movie.'''
...
'''In this section of python coding. 
I am using Doctor Strang Movie Trailer that is using sytext of media.py to genrate that infornation on this movie.'''
